...
def write_PTCtable(filename, multipole_orders, time, normal_components, skew_components):
	...
	print '\n\tnormal_components.shape = ', normal_components.shape[0]
	arr[:,0] = time
...
B_40 = Read_TFS_Return_Data('./MADX_Tables/BSEXT40.tfs', fudge=1.)
print 'B_40 =', B_40
...
B_42 = Read_TFS_Return_Data('./MADX_Tables/BSEXT42.tfs', fudge=1.)
...
B_43 = Read_TFS_Return_Data('./MADX_Tables/BSEXT43.tfs', fudge=1.)
...
B_44 = Read_TFS_Return_Data('./MADX_Tables/BSEXT44.tfs', fudge=1.)
...
BSM40 = Read_TFS_Return_Data('./MADX_Tables/PI.BSM40.1.tfs')
