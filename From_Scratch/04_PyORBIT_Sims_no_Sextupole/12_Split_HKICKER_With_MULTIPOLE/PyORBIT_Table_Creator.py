...
B_40 = Read_Single_Column_TFS_Return_Data('./MADX_Tables/BSEXT40.tfs')
...
write_PTCtable('./PTC-PyORBIT_Tables/BSEXT40.dat', 3, B_40_final[:,0], B_40_final[:,1], np.zeros(len(B_40_final[:,0])))

B_42 = Read_Single_Column_TFS_Return_Data('./MADX_Tables/BSEXT42.tfs')
B_42_final = Create_Timing(1.1435E-3, 5.0314E-3, B_42)
write_PTCtable('./PTC-PyORBIT_Tables/BSEXT42.dat', 3, B_42_final[:,0], B_42_final[:,1], np.zeros(len(B_42_final[:,0])))

B_43 = Read_Single_Column_TFS_Return_Data('./MADX_Tables/BSEXT43.tfs')
B_43_final = Create_Timing(1.1435E-3, 5.0314E-3, B_43)
write_PTCtable('./PTC-PyORBIT_Tables/BSEXT43.dat', 3, B_43_final[:,0], B_43_final[:,1], np.zeros(len(B_43_final[:,0])))

B_44 = Read_Single_Column_TFS_Return_Data('./MADX_Tables/BSEXT44.tfs')
B_44_final = Create_Timing(1.1435E-3, 5.0314E-3, B_44)
write_PTCtable('./PTC-PyORBIT_Tables/BSEXT44.dat', 3, B_44_final[:,0], B_44_final[:,1], np.zeros(len(B_44_final[:,0])))

D_40 = Read_Single_Column_TFS_Return_Data('./MADX_Tables/BDIP40.tfs')
D_40_final = Create_Timing(1.1435E-3, 5.0314E-3, D_40)
write_PTCtable('./PTC-PyORBIT_Tables/BDIP40.dat', 3, D_40_final[:,0], D_40_final[:,1], np.zeros(len(D_40_final[:,0])))

D_42 = Read_Single_Column_TFS_Return_Data('./MADX_Tables/BDIP42.tfs')
D_42_final = Create_Timing(1.1435E-3, 5.0314E-3, D_42)
write_PTCtable('./PTC-PyORBIT_Tables/BDIP42.dat', 3, D_42_final[:,0], D_42_final[:,1], np.zeros(len(D_42_final[:,0])))

D_43 = Read_Single_Column_TFS_Return_Data('./MADX_Tables/BDIP43.tfs')
D_43_final = Create_Timing(1.1435E-3, 5.0314E-3, D_43)
write_PTCtable('./PTC-PyORBIT_Tables/BDIP43.dat', 3, D_43_final[:,0], D_43_final[:,1], np.zeros(len(D_43_final[:,0])))

D_44 = Read_Single_Column_TFS_Return_Data('./MADX_Tables/BDIP44.tfs')
D_44_final = Create_Timing(1.1435E-3, 5.0314E-3, D_44)
write_PTCtable('./PTC-PyORBIT_Tables/BDIP44.dat', 3, D_44_final[:,0], D_44_final[:,1], np.zeros(len(D_44_final[:,0])))
